...
#  define LIBFLATARRAY_ELEM_II(res) LIBFLATARRAY_ELEM_IV(LIBFLATARRAY_ELEM_III res)
#  define LIBFLATARRAY_ELEM_III(x, _) x LIBFLATARRAY_EMPTY()
#  define LIBFLATARRAY_ELEM_IV(x) x
#else
...
#  define BOOST_PP_SEQ_ELEM_III(x, _) x LIBFLATARRAY_EMPTY()
