...
public:
    ...
    bool any() const
    {
        __m256 buf0 = _mm256_or_ps(
            _mm256_or_ps(val[ 0], val[ 1]),
            _mm256_or_ps(val[ 2], val[ 3]));
    ...
    {
        val[ 0] = _mm256_sub_ps(val[ 0], other.val[ 0]);
        val[ 1] = _mm256_sub_ps(val[ 1], other.val[ 1]);
        val[ 2] = _mm256_sub_ps(val[ 2], other.val[ 2]);
        val[ 3] = _mm256_sub_ps(val[ 3], other.val[ 3]);
    }
    ...
    short_vec<float, 32> operator-(const short_vec<float, 32>& other) const
    {
        return short_vec<float, 32>(
            _mm256_sub_ps(val[ 0], other.val[ 0]),
            _mm256_sub_ps(val[ 1], other.val[ 1]),
            _mm256_sub_ps(val[ 2], other.val[ 2]),
            _mm256_sub_ps(val[ 3], other.val[ 3]));
    }

    inline
    void operator+=(const short_vec<float, 32>& other)
    {
        val[ 0] = _mm256_add_ps(val[ 0], other.val[ 0]);
        val[ 1] = _mm256_add_ps(val[ 1], other.val[ 1]);
        val[ 2] = _mm256_add_ps(val[ 2], other.val[ 2]);
        val[ 3] = _mm256_add_ps(val[ 3], other.val[ 3]);
    }
    ...
    {
        return short_vec<float, 32>(
            _mm256_add_ps(val[ 0], other.val[ 0]),
            _mm256_add_ps(val[ 1], other.val[ 1]),
            _mm256_add_ps(val[ 2], other.val[ 2]),
            _mm256_add_ps(val[ 3], other.val[ 3]));
    }

    inline
    void operator*=(const short_vec<float, 32>& other)
    {
        val[ 0] = _mm256_mul_ps(val[ 0], other.val[ 0]);
        val[ 1] = _mm256_mul_ps(val[ 1], other.val[ 1]);
        val[ 2] = _mm256_mul_ps(val[ 2], other.val[ 2]);
        val[ 3] = _mm256_mul_ps(val[ 3], other.val[ 3]);
    }
    ...
    {
        return short_vec<float, 32>(
            _mm256_mul_ps(val[ 0], other.val[ 0]),
            _mm256_mul_ps(val[ 1], other.val[ 1]),
            _mm256_mul_ps(val[ 2], other.val[ 2]),
            _mm256_mul_ps(val[ 3], other.val[ 3]));
    }

    inline
    void operator/=(const short_vec<float, 32>& other)
    {
        val[ 0] = _mm256_mul_ps(val[ 0], _mm256_rcp_ps(other.val[ 0]));
        val[ 1] = _mm256_mul_ps(val[ 1], _mm256_rcp_ps(other.val[ 1]));
        val[ 2] = _mm256_mul_ps(val[ 2], _mm256_rcp_ps(other.val[ 2]));
        val[ 3] = _mm256_mul_ps(val[ 3], _mm256_rcp_ps(other.val[ 3]));
    }
    ...
    {
        return short_vec<float, 32>(
            _mm256_mul_ps(val[ 0], _mm256_rcp_ps(other.val[ 0])),
            _mm256_mul_ps(val[ 1], _mm256_rcp_ps(other.val[ 1])),
            _mm256_mul_ps(val[ 2], _mm256_rcp_ps(other.val[ 2])),
            _mm256_mul_ps(val[ 3], _mm256_rcp_ps(other.val[ 3])));
    }
    ...
    {
        return short_vec<float, 32>(
            _mm256_cmp_ps(val[ 0], other.val[ 0], _CMP_LT_OS),
            _mm256_cmp_ps(val[ 1], other.val[ 1], _CMP_LT_OS),
            _mm256_cmp_ps(val[ 2], other.val[ 2], _CMP_LT_OS),
            _mm256_cmp_ps(val[ 3], other.val[ 3], _CMP_LT_OS));
    }
    ...
    {
        return short_vec<float, 32>(
            _mm256_cmp_ps(val[ 0], other.val[ 0], _CMP_LE_OS),
            _mm256_cmp_ps(val[ 1], other.val[ 1], _CMP_LE_OS),
            _mm256_cmp_ps(val[ 2], other.val[ 2], _CMP_LE_OS),
            _mm256_cmp_ps(val[ 3], other.val[ 3], _CMP_LE_OS));
    }
    ...
    {
        return short_vec<float, 32>(
            _mm256_cmp_ps(val[ 0], other.val[ 0], _CMP_EQ_OQ),
            _mm256_cmp_ps(val[ 1], other.val[ 1], _CMP_EQ_OQ),
            _mm256_cmp_ps(val[ 2], other.val[ 2], _CMP_EQ_OQ),
            _mm256_cmp_ps(val[ 3], other.val[ 3], _CMP_EQ_OQ));
    }
    ...
    {
        return short_vec<float, 32>(
            _mm256_cmp_ps(val[ 0], other.val[ 0], _CMP_GT_OS),
            _mm256_cmp_ps(val[ 1], other.val[ 1], _CMP_GT_OS),
            _mm256_cmp_ps(val[ 2], other.val[ 2], _CMP_GT_OS),
            _mm256_cmp_ps(val[ 3], other.val[ 3], _CMP_GT_OS));
    }
    ...
    {
        return short_vec<float, 32>(
            _mm256_cmp_ps(val[ 0], other.val[ 0], _CMP_GE_OS),
            _mm256_cmp_ps(val[ 1], other.val[ 1], _CMP_GE_OS),
            _mm256_cmp_ps(val[ 2], other.val[ 2], _CMP_GE_OS),
            _mm256_cmp_ps(val[ 3], other.val[ 3], _CMP_GE_OS));
    }
    ...
    {
        return short_vec<float, 32>(
            _mm256_sqrt_ps(val[ 0]),
            _mm256_sqrt_ps(val[ 1]),
            _mm256_sqrt_ps(val[ 2]),
            _mm256_sqrt_ps(val[ 3]));
    }

    inline
    void load(const float *data)
    {
        val[ 0] = _mm256_loadu_ps(data +  0);
        val[ 1] = _mm256_loadu_ps(data +  8);
        val[ 2] = _mm256_loadu_ps(data + 16);
        val[ 3] = _mm256_loadu_ps(data + 24);
    }
    ...
    void load_aligned(const float *data)
    {
        ...
        val[ 0] = _mm256_load_ps(data +  0);
        val[ 1] = _mm256_load_ps(data +  8);
        val[ 2] = _mm256_load_ps(data + 16);
        val[ 3] = _mm256_load_ps(data + 24);
    }

    inline
    void store(float *data) const
    {
        _mm256_storeu_ps(data +  0, val[ 0]);
        _mm256_storeu_ps(data +  8, val[ 1]);
        _mm256_storeu_ps(data + 16, val[ 2]);
        _mm256_storeu_ps(data + 24, val[ 3]);
    }
    ...
    {
        SHORTVEC_ASSERT_ALIGNED(data, 32);
        _mm256_store_ps(data +  0, val[ 0]);
        _mm256_store_ps(data +  8, val[ 1]);
        _mm256_store_ps(data + 16, val[ 2]);
        _mm256_store_ps(data + 24, val[ 3]);
    }
    ...
    {
        SHORTVEC_ASSERT_ALIGNED(data, 32);
        _mm256_stream_ps(data +  0, val[ 0]);
        _mm256_stream_ps(data +  8, val[ 1]);
        _mm256_stream_ps(data + 16, val[ 2]);
        _mm256_stream_ps(data + 24, val[ 3]);
    }
    ...
    void gather(const float *ptr, const int *offsets)
    {
        ...
        val[ 0] = _mm256_insertf128_ps(val[ 0], tmp, 0);
        ...
        val[ 0] = _mm256_insertf128_ps(val[ 0], tmp, 1);
        ...
        val[ 1] = _mm256_insertf128_ps(val[ 1], tmp, 0);
        ...
        val[ 1] = _mm256_insertf128_ps(val[ 1], tmp, 1);
        ...
        val[ 2] = _mm256_insertf128_ps(val[ 2], tmp, 0);
        ...
        val[ 2] = _mm256_insertf128_ps(val[ 2], tmp, 1);
        ...
        val[ 3] = _mm256_insertf128_ps(val[ 3], tmp, 0);
        ...
        val[ 3] = _mm256_insertf128_ps(val[ 3], tmp, 1);
    }
#endif
    ...
    {
        __m128 tmp;
        tmp = _mm256_extractf128_ps(val[ 0], 0);
        ...
        tmp = _mm256_extractf128_ps(val[ 0], 1);
        ...
        tmp = _mm256_extractf128_ps(val[ 1], 0);
        ...
        tmp = _mm256_extractf128_ps(val[ 1], 1);
        ...
        tmp = _mm256_extractf128_ps(val[ 2], 0);
        ...
        tmp = _mm256_extractf128_ps(val[ 2], 1);
        ...
        tmp = _mm256_extractf128_ps(val[ 3], 0);
        ...
        tmp = _mm256_extractf128_ps(val[ 3], 1);
    ...
    {
        val[ 0] = _mm256_blendv_ps(val[ 0], other.val[ 0], mask.val[ 0]);
        val[ 1] = _mm256_blendv_ps(val[ 1], other.val[ 1], mask.val[ 1]);
        val[ 2] = _mm256_blendv_ps(val[ 2], other.val[ 2], mask.val[ 2]);
        val[ 3] = _mm256_blendv_ps(val[ 3], other.val[ 3], mask.val[ 3]);
    }
...
short_vec<float, 32>::short_vec(const sqrt_reference<float, 32>& other) :
    val{_mm256_sqrt_ps(other.vec.val[ 0]),
        _mm256_sqrt_ps(other.vec.val[ 1]),
        _mm256_sqrt_ps(other.vec.val[ 2]),
        _mm256_sqrt_ps(other.vec.val[ 3])}
{}

inline
void short_vec<float, 32>::operator/=(const sqrt_reference<float, 32>& other)
{
    val[ 0] = _mm256_mul_ps(val[ 0], _mm256_rsqrt_ps(other.vec.val[ 0]));
    val[ 1] = _mm256_mul_ps(val[ 1], _mm256_rsqrt_ps(other.vec.val[ 1]));
    val[ 2] = _mm256_mul_ps(val[ 2], _mm256_rsqrt_ps(other.vec.val[ 2]));
    val[ 3] = _mm256_mul_ps(val[ 3], _mm256_rsqrt_ps(other.vec.val[ 3]));
}
...
{
    return short_vec<float, 32>(
        _mm256_mul_ps(val[ 0], _mm256_rsqrt_ps(other.vec.val[ 0])),
        _mm256_mul_ps(val[ 1], _mm256_rsqrt_ps(other.vec.val[ 1])),
        _mm256_mul_ps(val[ 2], _mm256_rsqrt_ps(other.vec.val[ 2])),
        _mm256_mul_ps(val[ 3], _mm256_rsqrt_ps(other.vec.val[ 3])));
}
