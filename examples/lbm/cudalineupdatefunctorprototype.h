...
public:
    ...
    void operator()(ACCESSOR1 accessor1, long *index1, ACCESSOR2 accessor2, long *index2) const
    {
...
#define IMPLEMENTATION(CELL, X1, Y1, Z1, X2, Y2, Z2)                    \
    ...
    void CudaLineUpdateFunctorPrototype<CellLBM>::operator()(           \
        LibFlatArray::soa_accessor<CELL, X1, Y1, Z1, 0> accessor1, long *index1, \
        LibFlatArray::soa_accessor<CELL, X2, Y2, Z2, 0> accessor2, long *index2) const \
    {                                                                   \
