...
public:
    ...
    void gather(const float *ptr, unsigned *offsets)
    {
        ...
        indices = _mm256_loadu_si256(reinterpret_cast<__m256i *>(offsets + 8));
        val2    = _mm256_i32gather_ps(ptr, indices, 4);
        indices = _mm256_loadu_si256(reinterpret_cast<__m256i *>(offsets + 16));
        val3    = _mm256_i32gather_ps(ptr, indices, 4);
        indices = _mm256_loadu_si256(reinterpret_cast<__m256i *>(offsets + 24));
